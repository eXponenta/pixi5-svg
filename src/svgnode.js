...
import { PalettedGraphics, Palette } from "./paletted";
...
export class SVGNode extends PalettedGraphics {
	/**
	...
	constructor(svg, options, root = undefined) {
		super( root? root.palette : new Palette(undefined, 128), options.use32Indexes);
